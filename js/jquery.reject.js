/*
 * !! Customized version by Dieter Geerts <dieter.geerts@axians.com>!!
 *
    ...
    $.reject = function(options) {
        ...
        if (opts.browserShow) {
            ...
            for (var x in opts.display) {
                ...
                html += ''
                    + '<li id="jr_'+browser+'">'
                    + '  <div class="jr_icon_shadow"></div>'
                    + '  <img class="jr_icon"/>'
                    + '  <div><a href="'+url+'">'+(info.text || 'Unknown')+'</a></div>'
                    + '</li>';
        ...
        element.find('#jr_inner li .jr_icon').each(function() {
            ...
            var self = $(this);
            self.attr('src',''+opts.imagePath+'browser_'+(self.parent('li').attr('id').replace(/jr_/,''))+'.svg');
